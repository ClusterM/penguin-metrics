...
class ProcessCollector(MultiSourceCollector):
    ...
    def create_sensors(self) -> list[Sensor]:
        ...
        prefix = f"Process {self.config.label} " if is_system else ""
        ...
        if self.config.aggregate:
            sensors.append(
                build_sensor(
                    ...
                    source_name=self.name,
                    metric_name="count",
                    display_name=f"{prefix}Process Count",
                    device=device,
                    topic_prefix=self.topic_prefix,
            ...
            sensors.extend(
                [
                    build_sensor(
                        ...
                        display_name=f"{prefix}Memory RSS",
                        device=device,
                        topic_prefix=self.topic_prefix,
                        unit="MiB",
                    ...
                    build_sensor(
                        ...
                        display_name=f"{prefix}Memory Usage",
                        device=device,
                        topic_prefix=self.topic_prefix,
                        unit="%",
                        state_class=StateClass.MEASUREMENT,
        ...
        if self.config.fds:
            sensors.append(
                build_sensor(
                    ...
                    source_name=self.name,
                    metric_name="num_fds",
                    display_name=f"{prefix}Open Files",
                    device=device,
                    topic_prefix=self.topic_prefix,
                    state_class=StateClass.MEASUREMENT,
